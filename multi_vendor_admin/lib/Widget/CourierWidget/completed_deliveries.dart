...
class CompletedDeliveriesCourier extends StatefulWidget {
  const CompletedDeliveriesCourier({
    Key? key,
  }) : super(key: key);
  @override
  State<CompletedDeliveriesCourier> createState() =>
      _CompletedDeliveriesCourierState();
}

class _CompletedDeliveriesCourierState
    extends State<CompletedDeliveriesCourier> {
  bool isLoaded = false;
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(
                              width: MediaQuery.of(context).size.width / 2,
                              child: Text(result.deliveryBoysName,
                                  style: const TextStyle(fontSize: 12))),
                        ],
                      ),
                      const SizedBox(height: 20),
                      Row(
                        children: [
                          ...
                          SizedBox(
                              width: MediaQuery.of(context).size.width / 2,
                              child: Text(result.deliveryBoysPhone,
                                  style: const TextStyle(fontSize: 12))),
                        ],
                      ),
                      const SizedBox(height: 20),
